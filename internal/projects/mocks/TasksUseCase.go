...
// TasksUseCase is an autogenerated mock type for the TasksUseCase type
type TasksUseCase struct {
	mock.Mock
}

// AddMember provides a mock function with given fields: ctx, taskID, userID
func (_m *TasksUseCase) AddMember(ctx context.Context, taskID int64, userID int64) error {
...
func (_m *TasksUseCase) Create(ctx context.Context, task *models.Task) (*models.Task, error) {
...
func (_m *TasksUseCase) Delete(ctx context.Context, taskID int64) error {
...
func (_m *TasksUseCase) DeleteMember(ctx context.Context, taskID int64, userID int64) error {
	ret := _m.Called(ctx, taskID, userID)
...
func (_m *TasksUseCase) Get(ctx context.Context, projectID int64) ([]*models.Task, error) {
...
func (_m *TasksUseCase) GetMembers(ctx context.Context, taskID int64) ([]*models.User, error) {
	ret := _m.Called(ctx, taskID)
...
func (_m *TasksUseCase) IsMember(ctx context.Context, taskID int64, userID int64) (bool, error) {
	ret := _m.Called(ctx, taskID, userID)
...
func (_m *TasksUseCase) Start(ctx context.Context, taskID int64, userID int64) error {
	ret := _m.Called(ctx, taskID, userID)
...
func (_m *TasksUseCase) Stop(ctx context.Context, taskID int64, userID int64) error {
	ret := _m.Called(ctx, taskID, userID)
...
func (_m *TasksUseCase) Update(ctx context.Context, task *models.Task) (*models.Task, error) {
	ret := _m.Called(ctx, task)
...
// NewTasksUseCase creates a new instance of TasksUseCase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTasksUseCase(t interface {
	mock.TestingT
	Cleanup(func())
}) *TasksUseCase {
	mock := &TasksUseCase{}
