...
func (_m *Handlers) AddMember() gin.HandlerFunc {
	ret := _m.Called()
...
func (_m *Handlers) Create() gin.HandlerFunc {
	ret := _m.Called()
...
func (_m *Handlers) GetByID() gin.HandlerFunc {
	ret := _m.Called()
...
// GetMemberProductivity provides a mock function with given fields:
func (_m *Handlers) GetMemberProductivity() gin.HandlerFunc {
	ret := _m.Called()
...
func (_m *Handlers) GetMembers() gin.HandlerFunc {
	ret := _m.Called()
...
// RemoveMember provides a mock function with given fields:
func (_m *Handlers) RemoveMember() gin.HandlerFunc {
	ret := _m.Called()
