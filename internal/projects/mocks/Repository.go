...
func (_m *Repository) AddMember(ctx context.Context, projectID int64, userID int64) error {
...
func (_m *Repository) Create(ctx context.Context, project *models.Project) (*models.Project, error) {
...
func (_m *Repository) Delete(ctx context.Context, projectID int64) error {
...
func (_m *Repository) GetByID(ctx context.Context, projectID int64) (*models.Project, error) {
	ret := _m.Called(ctx, projectID)
...
func (_m *Repository) GetMemberProductivity(ctx context.Context, projectID int64, userID int64) ([]models.UserProductivity, error) {
	ret := _m.Called(ctx, projectID, userID)
...
func (_m *Repository) GetMembers(ctx context.Context, projectID int64) ([]*models.User, error) {
	ret := _m.Called(ctx, projectID)
...
func (_m *Repository) IsMember(ctx context.Context, projectID int64, userID int64) (bool, error) {
	ret := _m.Called(ctx, projectID, userID)
...
func (_m *Repository) IsOwner(ctx context.Context, projectID int64, userID int64) (bool, error) {
	ret := _m.Called(ctx, projectID, userID)
...
func (_m *Repository) RemoveMember(ctx context.Context, projectID int64, userID int64) error {
	ret := _m.Called(ctx, projectID, userID)
...
func (_m *Repository) Update(ctx context.Context, updates *models.Project) (*models.Project, error) {
